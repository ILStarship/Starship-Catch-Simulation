...
fuel_bar = FuelBar(150, 29, 100, 30)
...
# --- Infoscreen Buttons ---
back_button = Button("<Back", 5, 5, 50, 20, (0,0,0), (128, 128, 128))
...
while running:
    ...
    #        while running:
        ...
        propellant_banner.render_text("PROPELLANT", 10, 30)
        ...
        descent_rate_banner.render_text(f"Descent Rate: {descent_rate:.2f}", 10, 70)
        # Sink-rate warning
        if descent_rate>catch_max_descent_rate and starship.landing_flip_executed:
            sinkrate_warning.render_text(f"SINK-RATE! MAX: {catch_max_descent_rate}", 10, 120)
